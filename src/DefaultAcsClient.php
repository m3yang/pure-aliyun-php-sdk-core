 ...
 * under the License.
 */
namespace AliPure\AliCore;

use AliPure\AliCore\Regions\LocationService;
use AliPure\AliCore\Auth\RamRoleArnService;
use AliPure\AliCore\Auth\EcsRamRoleService;
use AliPure\AliCore\Exception\ClientException;
use AliPure\AliCore\Regions\EndpointProvider;
use AliPure\AliCore\Http\HttpHelper;
use AliPure\AliCore\Exception\ServerException;
